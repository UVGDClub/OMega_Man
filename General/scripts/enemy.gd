...
const EXPLOSION_SMALL = preload("res://General/objects/vfx/vfx_explosion_small.tscn")

const DEATH_SMALL = preload("res://General/sfx/temp/enemy/death_small.ogg")
const DEFLECT = preload("res://General/sfx/temp/enemy/deflect.ogg")
const HIT = preload("res://General/sfx/temp/enemy/hit.ogg")
