...
const SFX_GOAL = preload("res://General/sfx/temp/level/tada1.wav")
const SFX_1UP = preload("res://General/sfx/temp/player/1up.wav")
...
func _ready():
	...
	match(item_type):
		0:
			#health
			if(size == 0):
				sprite.texture = load("res://General/sprites/Items/health_small.png")
			else:
				sprite.texture = load("res://General/sprites/Items/health_big.png")
		1:
			#ammo
			if(size == 0):
				sprite.texture = load("res://General/sprites/Items/ammo_small.png")
			else:
				sprite.texture = load("res://General/sprites/Items/ammo_big.png")
			pass
		2:
			#extra life
			sprite.texture = load("res://General/sprites/Items/1up.png")
			sprite.hframes = 1
			pass
